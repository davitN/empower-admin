  ...
  const renderHeader = () => {
    return (
      <div className={classes.header}>
        ...
        <Button label="Bulk upload users" icon="pi pi-plus" className="p-button-info p-ml-3" />
        <Button label="Add user" icon="pi pi-plus" className="p-button-info p-ml-3" />
      </div>
    );
  };

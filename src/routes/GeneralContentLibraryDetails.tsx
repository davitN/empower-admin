...
const GeneralContentLibraryDetails = () => {
  ...
  const selectedType: GeneralContentLibraryType = (searchParams.get('type') as GeneralContentLibraryType) || 'POWER_UP';

  return (
    selectedType === 'ETHOS'
      ? <GeneralContentEthosDetails selectedType={selectedType} isNewItem={isNewItem} />
      : <GeneralContentItemDetails selectedType={selectedType} isNewItem={isNewItem} />
  );
};
